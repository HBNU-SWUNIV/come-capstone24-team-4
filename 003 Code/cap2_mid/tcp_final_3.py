    ...
    def control_1(sock):
        ...
        while True:
            ...
            if  sw2==False:
                ...
                print("infoo"+(str(result1)),flush=True)
                sock.send(result1.encode('utf-8'))
                sw2=True
            if sw300==0:
                if sw500==False:
                    ...
                    sw500=True
                print(str(now)+"abcdef",flush=True)
                ...
                print(str(imsi5)+" imsi5",flush=True)
            sw300=2
            ...
            if received=="cam":
                ...
                while True:
                    if sw>=1 and sw<100:
                        ...
                        print('\n\n')
                        print(result)
                        if received.startswith("stopcam"):
                            break
                    sw+=1
                    time.sleep(1)
                    print(sw)
            ...
            if imsi100==True:
                try:
                    ...
                    print(result[1])
                    if result[1]>=0 and result[1]<150:
                        print("dooropen-unlocked",flush=True)  
                        setServoPos(0)
                        sleep(1)
                        setServoPos(90)
                        sleep(1)
    ...
    def control_2():
        ...
        while True:
            if swlast ==0:     
                ...
                if(state == True):
                    pass
                    print("state: Motion detected",flush=True)
                    iimsi100=True
                else:
                    print ("state: No Motion",flush=True)
                    imsi100=False
                time.sleep(5) 
